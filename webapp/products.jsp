		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<div class="navbar-nav me-auto mb-2 mb-lg-0">
				...
				<div class="nav-item y me-lg-4 me-xl-5 tillium">
					<a class="nav-link active" href="products.jsp"><i
...
<body
	...
	<main class="container-fluid">
		...
		<div class="row mt-2 mx-1">
			...
			<div class="col col-sm-4 col-lg-8 mt-2 mt-sm-0">
				<button class="btn btn-warning" type="button"
					data-bs-toggle="collapse" data-bs-target="#content"
					aria-expanded="false" aria-controls="content">Advanced
					Search</button>
			</div>
			...
			<div class="collapse mt-2" id="content">
				...
				<div class="col p-3 text-white"
					style="background-color: #5a5a5a; border-radius: 10px;">

					<div class="row">

						<form class="col form-inline advanced-search-form">
							<div class="row">
								<div class="col-12 col-md-4 form-group">
									<label for="search-input" class="mb-1">Search:</label> <input
										type="text" class="form-control text-dark" id="search-input"
										placeholder="Enter keywords">
								</div>
							</div>
							<div class="col-12 col-md-4 form-group">
								<label for="category-select" class="mb-1">Category:</label> <select
							...
							<div class="col-12 col-md-4 d-flex align-items-center mt-4 pt-1">
								<div onclick="search();" class="btn btn-primary">
								...
								<div class="row p-2 bg-blackish border rounded bg-blackish my-3">
									...
									<div class="col-md-3 mt-1">
										<img class="img-fluid img-responsive rounded"
											src="seller/<?php echo $d["photo1"]; ?>">
									</div>
									<div class="col-md-6 mt-1">
										<div class="row">
											<div class="col-12 text-center">

												<h5 class="pf text-warning">
													<span class="text-secondary">Category >>> </span>
													<?php echo $dy["category"]; ?>
												</h5>
											</div>

											<h5 class="pf text-primary">
												<?php echo $d["title"]; ?>
											</h5>

											<div class="col text-center my-1">
												<h6 class="text-dark rounded p-1"
													style="background-color: #95f48d;">
													Auction Started -
													<?php echo $d["auctionStart"]; ?>
												</h6>
												<h6 class="text-light bg-danger rounded p-1">
													Auction Ending - <span class="blink-text text-dark"><b>
															<?php echo $d["auctionEnd"]; ?>
													</b></span>
												</h6>
											</div>
											<div class="bg-light rounded p-2 mb-3"
												style="overflow-y: scroll; max-height: 200px; opacity: 90%;">
												<div>
													<p
														class="text-justify fs-5 para text-muted text-truncate mb-0">
									...
									<div class="justify-content-center align-middle col-md-3 mt-1">
										...
										<div class="d-flex flex-row">
											<div class="col p-1 rounded text-center"
												style="background-color: #7afefe;">
										...
										<div class="d-flex flex-column mt-4">
											<a href="product_view.php?item_id=<?php echo $d["itemId"]; ?>"
												class="btn btn-primary btn-sm" type="button">Details</a> <a
												href="bidding_edit.php?itemId=<?php echo $d["itemId"]; ?>"
												class="btn btn-info btn-sm mt-2" type="button"> <i
												class="bi bi-hammer"></i> Edit
											</a>
										</div>
									</div>
								</div>
			...
			<div class="col-12 d-flex justify-content-center">
				<nav aria-label="...">
					<ul class="pagination">
						...
						<li class="page-item active"><a class="page-link" href="#">Next</a>
						</li>
					</ul>
				</nav>
			</div>
		...
		<h6>
			Next Web Refresh - <span id="nextRefresh" class="blink-text"></span>
		</h6>
	</main>
	...
	<script src="js/background_process.js"></script>
