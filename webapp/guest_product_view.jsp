...
<body class="text-dark gradient-custom">
	...
	<main class="container-fluid">
		...
		<div class="row d-flex justify-content-center my-3">
			...
			<div class="row my-3">
				<div class="col p-5 rounded text-center bg-light bg-opacity-50">
					<img src="img/products/Best-Arduino-Kit.jpg" alt="Girl in a jacket"
						width="400" height="400"> <img
						src="img/products/Best-Arduino-Kit.jpg" alt="Girl in a jacket"
						width="400" height="400"> <img
						src="img/products/Best-Arduino-Kit.jpg" alt="Girl in a jacket"
			...
			<div class="col-11 col-md-10 p-3 mt-3 bg-light rounded">
				...
				<div class="row">
					...
					<div class="col-12">
						<div class="col">
							<h3 class="pf text-primary"></h3>
						</div>
					</div>

					<div class="col-12">
						<div class="d-flex flex-row align-items-center">
							<h3 class="me-1">Rs.1500.00</h3>
							<!-- <span class="text-danger" style="text-decoration:line-through">$20.99</span> -->
						</div>

						<h6 class="text-danger">
							<i class="bi bi-currency-dollar"></i>Paid delivery
						</h6>
					</div>
					...
					<div class="col-12">
						<div class="d-flex flex-row">
							<div class="col p-1 rounded text-center"
								...
								<h5>
									Seller - <span style="color: brown;"></span>
								</h5>
							</div>
						</div>
					</div>

					<div class="co-12l text-center mt-2">
						<h6 class="text-dark rounded p-1"
							style="background-color: #95f48d;">Auction Started -</h6>
						<h6 class="text-light bg-danger rounded p-1">
							Auction Ending - <span class="blink-text text-dark"><b></span>
						</h6>
					</div>
					...
					<div class="col-12">
						<ul style="list-style: square; font-weight: bold;">
							<li>Warranty : <span class="text-primary">6 months
									warranty</span></li>
							<li>7 Days <span class="text-primary"> easy return
									policy</span></li>
							<li>Delivery Tracking : (<span class="text-info">
									Avialable</span>)
							</li>
							<li>Cash on Delivery : (<span class="text-info">
									Avialable</span>)
							</li>
						</ul>
					</div>
					...
					<div class="col-12 mb-3">
						<div class="d-flex flex-column px-5">
							...
							<div class="row">
								<a href="bidding.jsp" class="btn btn-primary"><i
									class="bi bi-hammer me-1"></i>Bid Now</a>
							</div>
										...
										<div class="row">
											<div class="col">
												...
												<div class="row">
													...
													<!-- card 1 -->
													<div
														class="col-12 col-sm-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
	...
	<script src="js/guest_products.js"></script>
	<script
