...
<body style="background-image: linear-gradient(to right, #8360c3, #2ebf91);">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <div class="nav-item y me-lg-4 me-xl-5 tillium">
                        <a class="nav-link " href="bidding.jsp"><i class="bi bi-bag-fill me-1"></i>PRODUCTS</a>
                    </div>
                    ...
                    <div class="nav-item dropdown y tillium">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark" style="background-color: #585858;">
                            ...
                            <li>
                                <a class="dropdown-item" href="user.jsp"><i class="bi bi-person-fill-gear me-1"></i>
                                    Logout</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col p-1 rounded-top mt-2 text-center bg-light border-bottom border-5">
                        ...
                        <div class="row text-start p-0">
                            <div class="col text-center"><br>
                                <img src="img/bidding.png" class="img-fluid rounded opacity-80" alt="" style="height: 50px;">
                            </div>
                    ...
                    <div class="col bg-light rounded-bottom p-3">
                        ...
                        <div class="row mx-1">
                            <div class="col-sm-12 col-md-6 border-bottom border-3">
                                <h2>Seller :</h2>
                                <h4><a href="https://imperialtrading.business.site/">Imperial Trading Company</a></h4>
                                <h6>No: <br>
                                    354,Colombo Road, <br>
                                    Gampaha, <br>
                                    11000, <br>
                        ...
                        <div class="row mx-1 border-bottom border-3 my-1">
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <h4>Issued Date : <span class="fs-5 text-secondary">15/12/2022</span></h4>
                            </div>
                        </div>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col"
                                                    class="bg-primary bg-opacity-50 rounded border border-3">Product
                                                    Image</th>
                                                <th scope="col"
                                                    class="bg-primary bg-opacity-50 rounded border border-3">Product
                                                    Name</th>
                                                <th scope="col"
                                                    ...
                                                    Description</th>
                                                <th scope="col"
                                                    class="bg-primary bg-opacity-50 rounded border border-3">Price</th>
                                                <th scope="col"
                                                    class="bg-primary bg-opacity-50 rounded border border-3">Qty</th>
                                                <th scope="col"
                                                    class="bg-primary bg-opacity-50 rounded border border-3">Total</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr scope="row">
                                                ...
                                                <td>
                                                    <img src="img/products/Best-Arduino-Kit.jpg" class="img-fluid"
                                                        alt="Product Image" style="height: 70px;">
                                                </td>

                                                <td><a href="product_view_sample.jsp">Best-Arduino-Kit</a></td>

                                                <td>
                                                    100%, original Light, weight,Best finish,
                                                    Standard design, For developers, Quality Tested
                                                    <small class="d-block text-muted">
                                                        <details>Arduino IoT Bundle allows
                                                            you to
                                                            build your next smart project. Ever wanted an automated
                                                            house? Or a
                                                            smart
                                                            garden? Well, now it’s easy with the Arduino IoT Cloud
                                                            compatible
                                                            boards. It
                                                            means: you can connect devices, visualize data, control and
                                                            share
                                                            your projects
                                                            from anywhere in the world. Wheth...</details>
                                                    </small>
                                                </td>

                                                <td>$13.99 <span><small><del class="text-danger">
                                                                $20.99</del></small></span>
                                                </td>

                                                <td>1.00</td>

                                                <td><strong>$ <span>13.99</span></strong></td>
                        ...
                        <div class="row text-end mx-1 mt-1">
                            ...
                            <div class="bg-success bg-opacity-50 offset-sm-5 col-sm-7 offset-md-7 col-md-5 offset-lg-8 col-lg-4 offset-xl-9 col-xl-3 offset-xxl-9 col-xxl-3 text-end"
                                style="border: double;">

                                <h5><strong class="pe-5">Total : </strong> <strong class="ps-5">$27.70</strong></h5>

                            </div>

                        </div>

                        <div class="row text-end my-3 me-5">
                            <div class="col">
                                <img src="img/signature.png" alt="Signature" class="img-fluid mt-3 me-3"
                                    style="height: 50px;">
                                <h6 class="p-2">Director's Signature</h6>
                            </div>
                        </div>

                        <div class="row text-center pt-4 pb-2 mx-1  border-top border-3 border-secondary border-opacity-75">
                            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4 text-center">
                                <h5><i class="bi bi-telephone-fill"></i> +94 782 883 947 / +94 332 220 919

                                </h5>
                            </div>
                            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4 text-center">
                                <h5><i class="bi bi-globe ms-2"></i> <a href="#">www.biddingsystem.com</a></h5>
                            </div>
                            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4 text-center">
                                <i class="bi bi-facebook ms-2 me-1"></i><a
                                    href="#">www.biddingsystem.facebook.com</a>
                            </div>
                        </div>
    ...
    <!-- Footer -->
    <footer class="text-center text-white mt-2" style="background-color: #3d3d3d;">
        <!-- Grid container -->
        <div class="container p-3">
            ...
            <section class="mb-4">
                ...
                <div class="mb-2">
                    <h5><i class="bi bi-telephone-fill"></i> Telephone : <span class="text-primary">+94 782 883 974 /
                            +94 332 220 919</span> </h5>
                </div>
                <!-- Facebook -->
