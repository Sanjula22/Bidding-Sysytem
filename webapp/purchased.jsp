				...
				<div class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<div class="nav-item y ms-lg-5 me-lg-4 me-xl-5">
						<a class="nav-link" aria-current="page"
							href="index.jsp"><i class="bi bi-house-door-fill me-1"></i>HOME</a>
					</div>
	...
	<main class="container-fluid">
		...
		<div class="content">
			...
			<div class="container-fluid">
				...
				<div class="row my-3">
					<div class="col p-1 rounded text-center bg-light bg-opacity-75">
						<h2 style="text-shadow: 5px 5px 5px rgba(82, 75, 75, 0.651);">
							Purchased Items</h2>
					</div>
				</div>
							...
							<table class="table table-striped">
								...
								<tbody>
									...
									<tr scope="row">
										...
										<td>100%, original Light, weight,Best finish, Standard
											design, For developers, Quality Tested <small
											class="d-block text-muted"> <details>Arduino
													IoT Bundle allows you to build your next smart project.
													Ever wanted an automated house? Or a smart garden? Well,
													now it’s easy with the Arduino IoT Cloud compatible boards.
													It means: you can connect devices, visualize data, control
													and share your projects from anywhere in the world.
													Wheth...
												</details>
										</small>
										</td>
										<td>$13.99 <span><small><del
														class="text-danger"> $20.99</del></small></span>
										</td>
										<td><a href="">Imperial Trading Company</a></td>
										<td>1.00</td>
										<td>2022/12/15</td>
										<td><a href="invoice.jsp" class="more">More Details</a></td>
				...
				<div class="mb-2">
					<h5>
						<i class="bi bi-telephone-fill"></i> Telephone : <span
							class="text-primary">+9478288397 / +94332220919</span>
					</h5>
				</div>
				<!-- Facebook -->
