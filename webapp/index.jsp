...
<nav class="navbar navbar-expand-lg navbar-dark sticky-top"
	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<div class="navbar-nav me-auto mb-2 mb-lg-2">
				...
				<div class="nav-item y me-lg-4 me-xl-5 tillium">
					<a class="nav-link" href="bidding.jsp"><i
						class="bi bi-bag-fill me-1"></i>PRODUCTS</a>
				</div>

				<div class="nav-item y me-lg-4 me-xl-5 tillium">
					<a class="nav-link" aria-current="page" href="buyer.jsp"><i
						class="bi bi-person-circle me-1"></i>BUYER</a>
				</div>

				<div class="nav-item y me-lg-4 me-xl-5 tillium">
					<a class="nav-link" aria-current="page" href="seller.jsp"><i
						class="bi bi-person-circle me-1"></i>SELLER</a>
				</div>

				<div class="nav-item y me-lg-4 me-xl-5 tillium">
					<a class="nav-link tillium" href="admin_panel_D.jsp"><i
						class="bi bi-bag-fill me-1"></i>SUMMARY</a>
				</div>
				...
				<div class="nav-item dropdown y tillium">
					...
					<ul class="dropdown-menu dropdown-menu-dark"
						...
						<li><a class="dropdown-item" href="user.jsp"><i
								class="bi bi-person-fill-gear me-1"></i> Logout</a></li>
					</ul>
				</div>
...
<body
	...
	<div class="row mt-2 mx-1">
		<div class="col col-sm-8 col-lg-4 text-center">
			<h5 class="mt-1">
				Welcome <span class="text-info"> <span class='text-dark'>to</span>
					BiddingZone <span class='text-dark'>!</span>
				</span>
			</h5>
		</div>
										...
										<div class="col">
											...
											<div class="row ">
												...
												<div class="col-12 col-sm-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
													<div class="card bg-trans">
														<div class="d-flex justify-content-between p-3">
															<p class="lead mb-0 text-warning pf">Yesterday's
																Combo Offer</p>
															<div
																class="bg-info rounded-circle d-flex align-items-center justify-content-center shadow-1-strong"
																style="width: 35px; height: 35px;">
														...
														<div class="row text-center">
															<a href="product_view_sample.jsp" class="col"> <img
