...
<link"C:/Users/sanju/eclipse-workspace/Bidding_System"
...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark sticky-top"
		...
		<div class="container-fluid">
			<a href="user.jsp" class="navbar-brand dicovery"> <img
				src="img/bidding.png" alt="" class="img-fluid mx-1"
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					<li class="nav-item y ms-lg-5 me-lg-4 me-xl-5"><a
					...
					<li class="nav-item y me-lg-4 me-xl-5 tillium"><a
						class="nav-link" href="products.jsp"> <i
					...
					<li class="nav-item dropdown y tillium"><a
						...
						<ul class="dropdown-menu dropdown-menu-dark"
							...
							<li><a class="dropdown-item" href="Sign_In.jsp"> <i
									class="bi bi-door-open-fill me-1"></i>Login
							</a></li>
						</ul></li>
				</ul>
			</div>
...
<body
	...
	<main class="container">
		<div class="row">
			<div
				class="col-12 col-sm-12 offset-md-1 col-md-10 offset-lg-2 col-lg-8 offset-xl-2 col-xl-8 bg-light p-sm-4 p-ms-5 p-lg-5 p-xl-5 p-xxl-5 p-3"
					...
					<div class="tab-pane fade show active" id=" pills-register"
						...
						<form action="insert" method="post">
							<div class="text-center">
								<div class="row py-3">
									<div class="col-12">
										<h3 class="animate-charcter2"
											style="font-size: 30px; font-style: oblique; font-weight: bolder;">User
											Register</h3>
									</div>
								</div>
							</div>

							<select id="role" class="form-select mb-4 bg-info text-center"
								style="font-weight: bold;" aria-label="Default select example">
								<option selected>Select Your Role</option>
								<option value="1" style="color: green; font-weight: bold;">Buyer</option>
								<option value="2" style="color: blue; font-weight: bold;">Seller</option>
							</select>
							...
							<div class="form-outline mb-4">
								<input type="text" id="uname" name="uname" class="form-control"
									required /> <label class="form-label" for="registerUsername">Username</label>
							</div>

							<!-- Email input -->
							<div class="form-outline mb-4">
								<input type="email" id="email" name="email" class="form-control"
									required /> <label class="form-label" for="registerEmail">Email</label>
							</div>
							...
							<div class="form-outline mb-3">
								<input type="tel" id="mobile" name="mobile" class="form-control"
									required /> <label class="form-label" for="form6Example6">Phone
									Number</label>
							</div>

							<!-- Address input-->
							<div class="form-outline mb-4">
								<input type="text" id="uname" name="address"
									class="form-control" required /> <label class="form-label"
									for="form6Example6">Address</label>
							</div>

							<!-- Checkbox -->
							<div class="form-check d-flex justify-content-center">
								<input class="form-check-input me-2" id="checkbox"
							...
							<div class="text-center">
								<p>
									Already a member? <a href="Sign_In.jsp">Sign_In Now</a>
								</p>
							</div>
						</form>
					</div>
	...
	<footer class="text-center text-white"
		...
		<div class="text-center p-3"
			...
			© 2023 Copyright: <a class="text-white" href="#">ceylongen.com</a>
		</div>
