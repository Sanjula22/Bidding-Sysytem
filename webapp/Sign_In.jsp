					...
					<div class="tab-pane fade show active" id="pills-login"
						...
						<form action="index.jsp" method="post">
							...
							<div class="form-outline mb-4">
								<input type="text" id="uname" class="form-control" required /> <label
							...
							<div class="form-outline mb-4">
								<input type="password" id="password" class="form-control"
									required /> <label class="form-label" for="loginPassword">Password</label>
							</div>

							<!-- Checkbox -->
							<div class="form-check d-flex justify-content-center">
								<input class="form-check-input me-2" type="checkbox"
									id="checkbox" required /> <label class="form-check-label"
							...
							<div class="text-center">
								<p>
									Not a member? <a href="Sign_Up.jsp">Register Now</a>
								</p>
							</div>
						</form>
					</div>
