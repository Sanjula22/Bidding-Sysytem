...
<body>
    ...
    <div class="h1">
        ...
        <div>
            ...
            <input type="file" id="photo" name="photo"  onchange="getImagePreview(event)">
        </div>

        <div id="preview"> </div> <!-- getting image preview to here -->

        <button class="b1">Delete account</button>
        <button class="b2"><a href="buyer.jsp"></a>Submit</button>
    </form>
    </div>
