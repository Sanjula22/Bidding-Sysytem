...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="stylesheet" href="buyerstyles.css">
</head>
...
<!-- Header -->
    ...
    <div class="bigrectangle">
        <h1 class="title"><u>Buyer Profile</u></h1>
        <div class="rec2">
 
            <div class="profilepic">
                <img src="img/bprofile.png" alt="Profile Photo"><br>
                <p class="profilephoto">Profile Photo</p>
            </div>
            <div class="rec456-container">
                <div class="rec4">Name</div>
                <div class="rec5">Email</div>
                <div class="rec6">Phone no</div>
                <div class="edit-button-container">
                    <button><a href="buyerprofileediting.jsp">Edit Profile</a></button>
                </div>
            </div>
        </div>
        <div class="rec3">
        ...
        <div class="rec7">Item details</div>
    </div>
