	...
	<div class="bigrectangle">
		...
		<div class="rec2">
			...
			<div class="textbox">
				<br>
				<div class="photo">
					<label for="photo">Item Photo : </label> <input type="file"
						id="photo" name="photo" onchange="getImagePreview(event)">
				</div>
				<div id="preview"></div>
				...
				<div class="idescription">
					<label for="idescription">Item Description : </label> <input
						type="text" id="idescription" name="idescription">
				</div>
				<br>
				<div class="brand">
				...
				<br>
				<div class="color">
					<label for="color">Color : </label> <input type="text" id="textbox"
						name="textbox">
				</div>
				<br>
				<div class="Price">
